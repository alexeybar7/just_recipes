...
class GetRecipesWithIngredientsUseCase @Inject constructor(
    private val recipesRepository: RecipesRepository
) {
    operator fun invoke(): Flow<SourceState<List<RecipeWithIngredients>>> =
        recipesRepository.getRecipesWithIngredients().asSourceState()
}
